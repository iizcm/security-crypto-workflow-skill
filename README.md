...
[![Category: Security](https://img.shields.io/badge/Category-Security-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `security-crypto-workflow-skill` |
...
cp -r security-crypto-workflow ~/.hermes/skills/security-crypto-workflow/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/security-crypto-workflow-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/security-crypto-workflow-skill.git ~/.hermes/skills/security-crypto-workflow/
```
...
```text
skill_view(name="security-crypto-workflow")
```
...
```text
Use the security crypto workflow skill to <describe your specific task here>
```
...
```text
Gunakan skill security crypto workflow untuk <deskripsikan tugas spesifik Anda di sini>
```
